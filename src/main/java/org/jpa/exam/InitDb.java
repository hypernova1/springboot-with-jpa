package org.jpa.exam;

import lombok.RequiredArgsConstructor;
import org.jpa.exam.domain.*;
import org.jpa.exam.domain.item.Book;
...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            Book book2 = createBook("Spring Book2", 25000, 200);
            em.persist(book2);
        ...
        public void dbInit2() {
            ...
            Book book2 = createBook("JPA1 Book2", 20000, 200);
            em.persist(book2);
